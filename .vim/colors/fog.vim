...
hi Normal                                  cterm=NONE  ctermfg=255  ctermbg=NONE  guifg=#6d767d  guibg=#ffffff  gui=NONE

set background=dark

" hi Cool                                    cterm=NONE  ctermfg=81 ctermbg=NONE
hi Cool                                    cterm=NONE  ctermfg=153 ctermbg=NONE
hi Hot                                     cterm=NONE  ctermfg=209 ctermbg=NONE
" hi Type                                    cterm=NONE  ctermfg=244  guifg=#bf8c00  gui=NONE
hi Type                                    cterm=NONE  ctermfg=81 ctermbg=NONE

hi ColorColumn                             cterm=NONE  ctermbg=15  guibg=#f1f3f5  gui=NONE
hi Comment                                 cterm=NONE  ctermfg=Gray guifg=#adb5bd  gui=italic
hi ConId                                   cterm=NONE  ctermfg=244  guifg=#bf8c00  gui=NONE
hi Conceal                                 cterm=NONE  ctermfg=4  guifg=#0099ff  gui=NONE
hi Constant                                cterm=NONE  ctermfg=244  guifg=#00a5ab  gui=NONE
hi Cursor                                  cterm=NONE  ctermfg=45  ctermbg=15  guifg=#00BAFF  guibg=#808487  gui=NONE
hi CursorColumn                            cterm=NONE  ctermbg=45  guibg=#e6eaed  gui=NONE
hi CursorLine                              cterm=NONE  ctermbg=237  guibg=#e6eaed  guisp=#61707a  gui=NONE
hi CursorLineNr                            cterm=NONE  ctermfg=255  gui=bold  guifg=#6d767d
hi DiffAdd                                 cterm=NONE  ctermfg=2  ctermbg=239  gui=NONE  guifg=#11ab00  guibg=#e6eaed  guisp=#11ab00  gui=NONE
hi DiffChange                              cterm=NONE  ctermfg=3  ctermbg=239  gui=NONE  guifg=#bf8c00  guibg=#e6eaed  guisp=#bf8c00  gui=NONE
hi DiffDelete                              cterm=NONE  ctermfg=1  ctermbg=236  gui=NONE  guifg=#ff4053  guibg=#e6eaed  gui=NONE
hi DiffText                                cterm=NONE  ctermfg=4  ctermbg=239  gui=NONE  guifg=#0099ff  guibg=#e6eaed  guisp=#0099ff  gui=NONE
...
hi Folded                                  cterm=NONE  ctermfg=244  ctermbg=NONE  guifg=#6d767d  guibg=#e6eaed  guisp=#ffffff  gui=NONE
hi HelpExample                             cterm=NONE  ctermfg=10  guifg=#61707a  gui=NONE
" hi Identifier                              cterm=NONE  ctermfg=234  guifg=#0099ff  gui=NONE
hi Identifier                              cterm=NONE  ctermfg=251  guifg=#0099ff  gui=NONE
hi IncSearch                               cterm=standout  ctermfg=9  gui=standout  guifg=#ff6200
hi LineNr                                  cterm=NONE  ctermfg=Gray  ctermbg=NONE  guifg=#808487  guibg=#e6eaed  gui=NONE
...
hi NonText                                 cterm=NONE  ctermfg=244  gui=NONE  guifg=#787e82  gui=NONE
hi Pmenu                                   cterm=NONE  ctermfg=244  ctermbg=NONE  guifg=#6d767d  guibg=#e6eaed  gui=reverse
hi PmenuSbar                               cterm=NONE  ctermfg=234  ctermbg=NONE  guifg=#1d252b  guibg=#6d767d  gui=reverse
hi PmenuSel                                cterm=underline  ctermfg=252 ctermbg=NONE  guifg=#808487  guibg=#1d252b  gui=reverse
hi PmenuThumb                              cterm=NONE  ctermfg=234  ctermbg=254  guifg=#6d767d  guibg=#ffffff  gui=reverse
hi PreProc                                 cterm=NONE  ctermfg=9  guifg=#ff6200  gui=NONE
hi Question                                cterm=NONE  ctermfg=6  gui=NONE  guifg=#00a5ab  gui=NONE
hi Search                                  cterm=reverse  ctermfg=249  ctermbg=244  guifg=#bf8c00  guibg=NONE gui=reverse
hi SignColumn                              cterm=NONE  ctermfg=11  ctermbg=NONE  guifg=#6d767d  guibg=NONE  gui=NONE
hi Special                                 cterm=NONE  ctermfg=245  guifg=#ff4053  gui=NONE
hi SpecialKey                              cterm=NONE  ctermfg=244  ctermbg=7  gui=NONE  guifg=#787e82  guibg=#e6eaed  gui=NONE
...
" hi Statement                               cterm=NONE  ctermfg=243  guifg=#11ab00  gui=NONE
hi Statement                               cterm=NONE  ctermfg=251  guifg=#11ab00  gui=NONE
hi StatusLine                              cterm=NONE  ctermfg=244 ctermbg=NONE  gui=reverse  guifg=#808487  guibg=#ffffff  guibg=NONE
hi StatusLineNC                            cterm=NONE  ctermfg=244  ctermbg=7  gui=reverse  guifg=#787e82  guibg=#e6eaed  guibg=NONE
hi TabLine                                 cterm=NONE  ctermfg=244 ctermbg=NONE  gui=underline  guifg=#6d767d  guibg=#e6eaed  guisp=#6d767d
hi TabLineFill                             cterm=NONE  ctermfg=244 ctermbg=NONE  gui=underline  guifg=#6d767d  guibg=#e6eaed  guisp=#6d767d
hi TabLineSel                              cterm=NONE  ctermfg=255 ctermbg=NONE  gui=underline,reverse  guifg=#808487  guibg=#1d252b  guisp=#6d767d
" hi Title                                   cterm=NONE  ctermfg=244  guifg=#ff6200  gui=NONE
hi Title                                   cterm=NONE  ctermfg=251  guifg=#ff6200  gui=NONE
hi Todo                                    cterm=NONE  ctermfg=1  ctermbg=NONE  guifg=#ff549b  guibg=NONE gui=bold
" hi Underlined                              cterm=NONE  ctermfg=234  guifg=#9854ff  gui=NONE
hi Underlined                              cterm=NONE  ctermfg=251  guifg=#9854ff  gui=NONE
" hi VarId                                   cterm=NONE  ctermfg=4  guifg=#0099ff  gui=NONE
hi VarId                                   cterm=NONE  ctermfg=147  guifg=#0099ff  gui=NONE
" hi VertSplit                               cterm=NONE  ctermfg=12  ctermbg=12  guifg=#787e82  guibg=#787e82  gui=NONE
hi VertSplit                               cterm=NONE  ctermfg=238  ctermbg=NONE  guifg=NONE  guibg=NONE  gui=NONE
hi Visual                                  cterm=NONE  ctermfg=232 ctermbg=240 gui=reverse  guifg=#808487  guibg=#ffffff  guibg=NONE
hi VisualNOS                               cterm=NONE  ctermbg=244 ctermbg=255 gui=reverse  guibg=#e6eaed  guibg=NONE
hi WarningMsg                              cterm=NONE  ctermfg=16  gui=NONE  guifg=#ff4053  gui=NONE
...
hi hsString                                cterm=NONE  ctermfg=244  guifg=#787e82  gui=NONE
hi hsStructure                             cterm=NONE  ctermfg=6  guifg=#00a5ab  gui=NONE
hi hsType                                  cterm=NONE  ctermfg=244  guifg=#bf8c00  gui=NONE
hi hsTypedef                               cterm=NONE  ctermfg=6  guifg=#00a5ab  gui=NONE
hi hsVarSym                                cterm=NONE  ctermfg=6  guifg=#00a5ab  gui=NONE
hi hs_DeclareFunction                      cterm=NONE  ctermfg=244  guifg=#ff6200  gui=NONE
hi hs_OpFunctionName                       cterm=NONE  ctermfg=244  guifg=#bf8c00  gui=NONE
hi hs_hlFunctionName                       cterm=NONE  ctermfg=4  guifg=#0099ff  gui=NONE
hi htmlArg                                 cterm=NONE  ctermfg=244  guifg=#787e82  gui=NONE
...
hi javaScript                              cterm=NONE  ctermfg=234  guifg=#bf8c00  gui=NONE
...
hi pandocBlockQuoteLeader3                 cterm=NONE  ctermfg=244  guifg=#bf8c00  gui=NONE
...
" hi rubyDefine                              cterm=NONE  ctermfg=10  ctermbg=NONE  gui=NONE  guifg=#61707a  guibg=#ffffff  gui=NONE
...
hi vimIsCommand                            cterm=NONE  ctermfg=244  guifg=#787e82  gui=NONE
